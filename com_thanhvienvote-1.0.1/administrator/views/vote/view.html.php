 ...
 * @since  1.6
 */
class ThanhvienvoteViewVote extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_THANHVIENVOTE_TITLE_VOTE'), 'vote.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_thanhvienvote.vote', $this->item->id);
		}
